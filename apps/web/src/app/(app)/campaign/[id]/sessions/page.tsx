    ...
    <div className="p-8 pt-5">
      ...
      {activeSession && (
        <div className="mb-6">
          ...
          <div className="bg-surface border border-saga-success/30 rounded-lg p-5">
      ...
      <div>
        <p className="text-[11px] text-saga-muted font-bold uppercase tracking-widest mb-2">
          Histórico · {pastSessions.length} sessões
        </p>
        {pastSessions.length === 0 ? (
          ...
          <div className="space-y-2">
            {pastSessions.map((s, i) => (
              <div key={s.id} className="flex items-center justify-between bg-surface border border-border rounded-lg px-5 py-4 hover:border-border-bright transition-all card-hover">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium">{s.name ?? `Sessão ${pastSessions.length - i}`}</p>
