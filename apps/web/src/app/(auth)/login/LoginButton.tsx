...
export default function LoginButton() {
  return (
    <button
      ...
      className="wax-seal flex w-full items-center justify-center gap-2.5 rounded-md px-5 py-3.5 font-cinzel text-sm uppercase tracking-[3px] transition hover:scale-[1.02] hover:brightness-110"
    >
