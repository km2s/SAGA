...
export default function LoginButton() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-2.5 py-3 px-4 bg-[#5865F2] hover:bg-[#4752c4] hover:shadow-[0_4px_16px_rgba(88,101,242,0.45)] text-white font-semibold text-sm rounded-lg transition-all hover:-translate-y-0.5"
    >
