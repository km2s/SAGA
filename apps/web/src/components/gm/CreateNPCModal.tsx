...
export function CreateNPCModal({ campaignId, players, open, onClose }: {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setForm({ name: '', description: '', imageUrl: '', type: 'NEUTRAL', isPublic: false, linkedMemberId: '' })
    onClose()
    router.refresh()
  }
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div className="grid grid-cols-2 gap-3">
          <div className="col-span-2">
            ...
            <input value={form.name} onChange={e => set('name', e.target.value)} placeholder="Malachor, o Lich..."
